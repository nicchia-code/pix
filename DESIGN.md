...
This file captures the technical decisions and operating constraints behind `pix`.

For the product-level overview and day-to-day usage, start with `README.md`.
